    ...
    units: [
      {
        ...
        questions: [
          ...
          {
            type: 'fill',
            question: '"______，潭面无风镜未磨。" 请填写空缺的诗句。',
            answer: ['湖光秋月两相和'],
            hint: '这是刘禹锡《望洞庭》的第一句，描写洞庭湖秋天的美景。',
            explanation: '<strong>解析：</strong><br>① 这是唐代诗人刘禹锡的《望洞庭》。<br>② 全诗：<strong>湖光秋月两相和</strong>，潭面无风镜未磨。遥望洞庭山水翠，白银盘里一青螺。<br>③ 第一句写了湖光与秋月相互映照的美景。'
          },
          {
            type: 'match',
            question: '将下列词语与正确的解释连线',
            leftItems: ['波澜壮阔', '水平如镜', '连绵起伏', '形态万千'],
            rightItems: ['水面平静像镜子一样', '波涛汹涌，气势雄壮', '形状和姿态千变万化', '山峦连接不断，高低起伏'],
            answer: [1, 0, 3, 2],
            hint: '先找最有把握的连线，比如"水平如镜"肯定和"镜子"有关。',
            explanation: '<strong>解析：</strong><br>① 波澜壮阔 → 波涛汹涌，气势雄壮<br>② 水平如镜 → 水面平静像镜子一样<br>③ 连绵起伏 → 山峦连接不断，高低起伏<br>④ 形态万千 → 形状和姿态千变万化'
          },
          {
            type: 'order',
            question: '将下列句子排列成一段描写景色的通顺段落',
            items: ['湖面上波光粼粼，像撒了一层碎金。', '远处，连绵起伏的群山在薄雾中若隐若现。', '站在洞庭湖边，放眼望去景色真美。', '近处，岸边的柳树在微风中轻轻摇摆。'],
            answer: [2, 0, 3, 1],
            hint: '写景一般按照从整体到局部、从近到远的顺序来组织。',
            explanation: '<strong>解析：</strong><br>① 先写"站在湖边"，交代观察的位置。<br>② 接着写"湖面"的近景。<br>③ 再写"岸边柳树"的近景。<br>④ 最后写"远处群山"的远景。<br>✅ <strong>正确顺序：</strong>站在洞庭湖边 → 湖面波光粼粼 → 岸边柳树摇摆 → 远处群山若隐若现。'
          }
        ]
      },
      {
        ...
        questions: [
          ...
          {
            type: 'fill',
            question: '"______，不亦乐乎？" 请填写空缺的句子。',
            answer: ['有朋自远方来'],
            hint: '这是《论语》中的名句，表达朋友远道而来的喜悦。',
            explanation: '<strong>解析：</strong><br>① 出自《论语·学而》。<br>② 完整句子：<strong>有朋自远方来</strong>，不亦乐乎？<br>③ 意思是：有志同道合的朋友从远方来，不是一件很令人高兴的事吗？'
          },
          {
            type: 'match',
            question: '将下列成语与正确的解释连线',
            leftItems: ['深情厚谊', '无微不至', '守望相助', '相亲相爱'],
            rightItems: ['守卫瞭望，互相帮助', '深厚的情感和友谊', '彼此亲近，互相关爱', '非常周到，没有一处不照顾到'],
            answer: [1, 3, 0, 2],
            hint: '先找最有把握的连线，比如"无微不至"和"周到"有关。',
            explanation: '<strong>解析：</strong><br>① 深情厚谊 → 深厚的情感和友谊<br>② 无微不至 → 非常周到，没有一处不照顾到<br>③ 守望相助 → 守卫瞭望，互相帮助<br>④ 相亲相爱 → 彼此亲近，互相关爱'
          },
          {
            type: 'order',
            question: '将下列句子排列成一段关于"人间真情"的通顺段落',
            items: ['爸爸的这份坚持，让我深深感受到父爱的伟大。', '救援人员都说没有希望了，但爸爸不肯放弃。', '地震发生后，爸爸徒手在废墟中挖掘了38个小时。', '最终，爸爸找到了被困的儿子，紧紧拥抱在一起。'],
            answer: [2, 1, 0, 3],
            hint: '按照事件发生的先后顺序：地震→挖掘→感悟→找到。',
            explanation: '<strong>解析：</strong><br>① 先写地震发生后爸爸开始挖掘。<br>② 再写别人放弃了但爸爸坚持。<br>③ 接着写"我"的感受——感悟到父爱的伟大。<br>④ 最后写结局——找到了儿子。<br>✅ <strong>正确顺序按时间发展排列。</strong>'
          }
        ]
      },
      {
        ...
        questions: [
          ...
          {
            type: 'fill',
            question: '"______，不知为不知，是知也。" 请填写空缺的句子。',
            answer: ['知之为知之'],
            hint: '这是孔子教导学生要诚实面对知识的名句。',
            explanation: '<strong>解析：</strong><br>① 出自《论语·为政》，是孔子教育子路的话。<br>② 完整句子：<strong>知之为知之</strong>，不知为不知，是知也。<br>③ 意思是：知道就是知道，不知道就是不知道，这才是真正的智慧。'
          },
          {
            type: 'match',
            question: '将下列成语与正确的解释连线',
            leftItems: ['精益求精', '孜孜不倦', '持之以恒', '废寝忘食'],
            rightItems: ['勤奋努力不知疲倦', '长久地坚持下去不放弃', '好了还要求更好', '专心到顾不上吃饭睡觉'],
            answer: [2, 0, 1, 3],
            hint: '先找最有把握的连线，比如"废寝忘食"和"吃饭睡觉"有关。',
            explanation: '<strong>解析：</strong><br>① 精益求精 → 好了还要求更好<br>② 孜孜不倦 → 勤奋努力不知疲倦<br>③ 持之以恒 → 长久地坚持下去不放弃<br>④ 废寝忘食 → 专心到顾不上吃饭睡觉'
          },
          {
            type: 'order',
            question: '将下列句子按孔子学琴的过程排列成正确的顺序',
            items: ['开始领悟作曲者（周文王）的精神世界', '掌握了曲子的旋律，已经会弹了', '体会到了曲子中蕴含的情感'],
            answer: [1, 2, 0],
            hint: '孔子学琴从浅到深：先会弹 → 再融入感情 → 最后理解作者。',
            explanation: '<strong>解析：</strong><br>① 孔子学琴经历了三个阶段。<br>② 第一阶段：掌握旋律（会弹）。<br>③ 第二阶段：体会情感（弹出感情）。<br>④ 第三阶段：理解作者（领悟精神）。<br>✅ 体现了<strong>精益求精、不断深入</strong>的学习态度。'
          }
        ]
      },
      {
        ...
        questions: [
          ...
          {
            type: 'fill',
            question: '"______，处处闻啼鸟。" 请填写空缺的诗句。',
            answer: ['春眠不觉晓'],
            hint: '这是孟浩然《春晓》的第一句，描写春天早晨的情景。',
            explanation: '<strong>解析：</strong><br>① 出自唐代诗人孟浩然的《春晓》。<br>② 完整句子：<strong>春眠不觉晓</strong>，处处闻啼鸟。夜来风雨声，花落知多少。<br>③ "春眠不觉晓"写春天睡得香甜，不知不觉天都亮了。'
          },
          {
            type: 'match',
            question: '将下列词语与正确的解释连线',
            leftItems: ['生机勃勃', '枝繁叶茂', '鸟语花香', '绿树成荫'],
            rightItems: ['鸟儿鸣叫，花儿飘香', '生命力旺盛有活力', '树木枝叶茂密遮住了阳光', '树木的枝叶非常茂盛'],
            answer: [1, 3, 0, 2],
            hint: '先看字面意思：比如"鸟语花香"明显和鸟鸣、花香有关。',
            explanation: '<strong>解析：</strong><br>① 生机勃勃 → 生命力旺盛有活力<br>② 枝繁叶茂 → 树木的枝叶非常茂盛<br>③ 鸟语花香 → 鸟儿鸣叫，花儿飘香<br>④ 绿树成荫 → 树木枝叶茂密遮住了阳光'
          },
          {
            type: 'order',
            question: '将下列句子排列成一段描写植物生长过程的通顺段落',
            items: ['渐渐地，叶子越长越多，变成了一片绿色。', '一场春雨过后，小苗从土里钻了出来。', '春天，我把一颗种子埋在花盆里。', '又过了几周，开出了第一朵小花。'],
            answer: [2, 1, 0, 3],
            hint: '按照植物生长的时间顺序：播种→发芽→长叶→开花。',
            explanation: '<strong>解析：</strong><br>① 先写播种（春天埋下种子）。<br>② 再写发芽（春雨后小苗钻出来）。<br>③ 接着写长叶（叶子越来越多）。<br>④ 最后写开花（第一朵小花绽放）。<br>✅ <strong>这就是植物从种子到开花的过程！</strong>'
          }
        ]
      },
      {
        ...
        questions: [
          ...
          {
            type: 'fill',
            question: '"______，尚思为国戍轮台。" 请填写空缺的诗句。',
            answer: ['僵卧孤村不自哀'],
            hint: '这是陆游《十一月四日风雨大作》的名句，表达至死不渝的爱国情怀。',
            explanation: '<strong>解析：</strong><br>① 出自陆游《十一月四日风雨大作》。<br>② 完整：<strong>僵卧孤村不自哀</strong>，尚思为国戍轮台。夜阑卧听风吹雨，铁马冰河入梦来。<br>③ 病卧孤村仍想为国守边疆，感人至深。'
          },
          {
            type: 'match',
            question: '将下列成语与正确的解释连线',
            leftItems: ['百折不挠', '英勇无畏', '视死如归', '坚贞不屈'],
            rightItems: ['勇敢而毫不畏惧', '坚守节操决不屈服', '无论受多少挫折都不退缩', '把死看作回家一样坦然'],
            answer: [2, 0, 3, 1],
            hint: '"视死如归"中的"归"是回家的意思。从这个线索入手。',
            explanation: '<strong>解析：</strong><br>① 百折不挠 → 无论受多少挫折都不退缩<br>② 英勇无畏 → 勇敢而毫不畏惧<br>③ 视死如归 → 把死看作回家一样坦然<br>④ 坚贞不屈 → 坚守节操决不屈服'
          },
          {
            type: 'order',
            question: '将下列句子排列成一段描写英雄品质的通顺段落',
            items: ['他说："为了不损伤大脑，我不用麻药。"', '刘伯承在战斗中眼部受了重伤，需要手术。', '这种钢铁般的意志，让所有人都为之震撼。', '整个手术过程中，他忍着剧痛，一声不吭。'],
            answer: [1, 0, 3, 2],
            hint: '按事件发生顺序：受伤→拒绝麻药→忍痛→人们被震撼。',
            explanation: '<strong>解析：</strong><br>① 先交代受伤需要手术。<br>② 再写拒绝麻药的决定。<br>③ 接着写手术中一声不吭。<br>④ 最后写人们的震撼感受。<br>✅ <strong>这就是"军神"的钢铁意志！</strong>'
          }
        ]
      },
      {
        ...
        questions: [
          ...
          {
            type: 'fill',
            question: '"______，铁马冰河入梦来。" 请填写空缺的诗句。',
            answer: ['夜阑卧听风吹雨'],
            hint: '这是陆游《十一月四日风雨大作》的名句，梦中都在想着上战场杀敌。',
            explanation: '<strong>解析：</strong><br>① 出自陆游《十一月四日风雨大作》。<br>② 完整：僵卧孤村不自哀，尚思为国戍轮台。<strong>夜阑卧听风吹雨</strong>，铁马冰河入梦来。<br>③ 老人在风雨之夜，梦中都是铁马冰河的战场，爱国之心令人泪目。'
          },
          {
            type: 'match',
            question: '将下列英雄品质的成语与解释连线',
            leftItems: ['舍生取义', '视死如归', '坚忍不拔', '前赴后继'],
            rightItems: ['把死看作回家一样从容', '前面的人倒下后面的人继续前进', '为正义牺牲自己的生命', '意志坚定、毫不动摇'],
            answer: [2, 0, 3, 1],
            hint: '"舍生取义"中"舍生"是舍弃生命，"取义"是追求正义。',
            explanation: '<strong>解析：</strong><br>① 舍生取义 → 为正义牺牲自己的生命<br>② 视死如归 → 把死看作回家一样从容<br>③ 坚忍不拔 → 意志坚定、毫不动摇<br>④ 前赴后继 → 前面倒下，后面继续前进'
          },
          {
            type: 'order',
            question: '将下列句子排列成一段通顺的英雄赞歌段落',
            items: ['在上甘岭战役中，敌人的机枪疯狂扫射。', '黄继光毫不犹豫地用胸膛堵住了敌人的枪眼。', '战友们高喊着口号冲了上去，取得了战斗的胜利。', '黄继光的英勇事迹永远铭记在我们心中。'],
            answer: [0, 1, 2, 3],
            hint: '按照战斗的时间顺序排列：战斗开始→黄继光行动→战友冲锋→永远铭记。',
            explanation: '<strong>解析：</strong><br>① 先写战斗背景（上甘岭战役）。<br>② 再写黄继光的英雄行动（堵枪眼）。<br>③ 接着写战斗结果（取得胜利）。<br>④ 最后写影响（永远铭记）。<br>✅ <strong>这就是志愿军英雄黄继光的故事！</strong>'
          }
        ]
      }
    ]
...
const ACHIEVEMENTS = [
  ...
  { id: 'learning_master', name: '学习达人', icon: '👑', desc: '连续签到30天', check: (s) => s.consecutiveDays >= 30 },
  { id: 'hard_worker', name: '勤学苦练', icon: '📝', desc: '累计正确答题100次', check: (s) => (s.totalCorrectAnswers || 0) >= 100 },
  { id: 'all_chinese', name: '语文通', icon: '📚', desc: '完成所有语文单元', check: (s) => ['c1','c2','c3','c4','c5','c6'].every(u => s.completedUnits.includes(u)) },
  { id: 'all_english', name: '英语全能', icon: '🌍', desc: '完成所有英语单元', check: (s) => ['e1','e2','e3','e4','e5','e6'].every(u => s.completedUnits.includes(u)) }
];

const SIGNIN_REWARDS = ['⭐ × 1', '⭐ × 2', '⭐ × 3 ⭐ × 4', '🎁 彩蛋 × 1', '⭐ × 5', '⭐ × 6', '🏆 连续7天！额外 +5⭐ + 彩蛋'];
